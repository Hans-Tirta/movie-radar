...
// Async wrapper to properly handle async middleware
const asyncHandler = (
...
// Main middleware for discussion service (calls auth service)
...
// Wrapped version for use in routes
const verifyToken = asyncHandler(verifyTokenAsync);
